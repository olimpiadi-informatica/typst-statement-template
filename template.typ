...
#let localize(lang, string) = {
  let localization = (
    ...
    "PageXofY": (
      ...
      "dv": (count, total) => "ޞަފްޙާ " + str(count) + " ގެ " + str(total),
    ),
    "Subtask": (
    ...
    "IntentionallyBlankPage": (
      ...
      "dv": "މި ޞަފްޙާއަކީ ގަސްތުގައި ހުސްކޮށް ބާއްވާފައިވާ ޞަފްޙާއެކެވެ",
    ),
    "defaultinputname": (
      "nl": "test",
      "en": "test",
